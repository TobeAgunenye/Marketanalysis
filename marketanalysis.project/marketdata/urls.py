...
from . import views 
from .views import StockSimulationAPIView
...
urlpatterns = [
    ...
    path('api/market-predictions/<str:company>/', views.MarketPredictionAPIView.as_view(), name='market-predictions'),
    path('api/stock-simulation/', StockSimulationAPIView.as_view(), name='stock-simulation'),
]
